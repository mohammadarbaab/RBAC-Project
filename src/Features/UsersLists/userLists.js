...
function UserLists() {
  ...
  const status = useSelector((state) => state.userLists.status);
  const error = useSelector((state) => state.userLists.error);
        ...
        {loading ? (
          ...
          <div className="col-span-full text-center">
            ...
            <p className="mt-4 text-gray-600">
              Loading... Please wait 2 minutes.Data fetch from (non production
              server)
            </p>
          </div>
